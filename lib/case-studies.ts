    ...
    outcomes: [
      {
        n: "$340k",
        l: "TVL",
        d: "Locked across 1,200+ vaults in first 90 days post-launch.",
      },
      { n: "1,200", l: "Vaults", d: "Real ones. We watched the cohort daily." },
      {
        n: "<2%",
        l: "Early withdrawal",
        d: "Far below the 18% we modeled — turns out time-locks work.",
      },
      {
        n: "94%",
        l: "Goal completion",
        d: "Percent of vaults that ran to maturity. The product worked.",
      },
    ],
    learned:
    ...
    outcomes: [
      {
        n: "47",
        l: "Beta users",
        d: "Quiet launch. No marketing. Word of mouth from one Twitter thread.",
      },
      { n: "11", l: "Paying", d: "$29/mo. Higher conversion than I expected." },
      {
        n: "90 days",
        l: "Spec → beta",
        d: "Solo. No outside funding. Lots of late nights.",
      },
      {
        n: "1.4M",
        l: "Tokens routed",
        d: "Through Zamir workflows in the first two months.",
      },
    ],
    learned:
    ...
    outcomes: [
      {
        n: "10",
        l: "Templates",
        d: "Covering Next.js, Vite, Clarity contracts (FT/NFT/custom), and test harnesses.",
      },
      {
        n: "40+",
        l: "Week-1 installs",
        d: "Organic. No marketing. Submitted to the Stacks ecosystem directory.",
      },
      {
        n: "100%",
        l: "CI coverage",
        d: "Every template passes its own tests on every commit.",
      },
      {
        n: "4.9★",
        l: "npm rating",
        d: "Among the few packages in the Stacks ecosystem with reviews.",
      },
    ],
    learned:
...
export const FEATURED_PROJECTS: FeaturedProject[] = CASE_STUDIES.map(
  ({ slug, idx, name, tag, year, desc, stack, role, duration, image }) => ({
    slug,
    idx,
    name,
    tag,
