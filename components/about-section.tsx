          ...
          <Tabs defaultValue="developer" className="w-full">
              ...
              <div className="content-card">
                <div className="prose dark:prose-invert max-w-none">
                  <p className="text-lg">
                    ...
                    experience, my focus is on engineering performant,
                    accessible, and intuitive frontends.
                  </p>
                  ...
                  <p className="mt-4">
                    My current professional goal is to build practical,
                    real-world solutions while expanding my frontend engineering
                    skills. I am actively studying{" "}
                    <strong>Zero-Knowledge proofs</strong> and{" "}
              ...
              <div className="content-card">
                <div className="prose dark:prose-invert max-w-none">
                  <p className="text-lg">
                    ...
                    opportunity to build systems that are orderly, purposeful,
                    and genuinely helpful to others. My core philosophy for
                    mastering these systems is learning them from first
                    principles.
                  </p>

                  <p className="mt-4">
                    This approach dictates what I build. I am currently
                    developing <strong>Zamir</strong>, an AI-driven
                    orchestration application, and{" "}
                    <strong>FirstCode Forge</strong>. To strengthen my
                    underlying architectural knowledge, I am also learning{" "}
                    <em>Flutter</em>. By stripping away abstractions, I aim to
                    understand exactly how tools work under the hood rather than
                  ...
                  <p className="mt-4">
                    ...
                    technical work with intention, ensuring that what I build
                    has a positive and useful impact.
                  </p>
                </div>
              </div>
            </TabsContent>
            ...
            <TabsContent value="person" className="animate-fade-in">
              <div className="content-card">
                <div className="prose dark:prose-invert max-w-none">
                  <p className="text-lg">
                    Outside of software development, I strive to maintain a
                    broad set of interests to stay well-rounded. Currently, I am
                    learning to play the <strong>guitar</strong>, studying{" "}
                    <strong>chess</strong> strategy, and practicing new
                    languages:
                  ...
                  <p className="mt-4">
                    ...
                    <em>
                      Economics, Arts, Business, Finance, Agriculture,
                      Psychology, Communication, and Leadership
                    </em>
                    . I find that concepts from one discipline often solve
                    problems in another, and I value the unique perspectives
                    that come from connecting with people across different
                    industries.
                  </p>
                </div>
              </div>
