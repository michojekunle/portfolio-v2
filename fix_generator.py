...
# 6. Generate button
content = content.replace('style={{ background: "#C85A2C" }}', 'className="w-full h-[52px] rounded-[10px] font-mono text-[12px] uppercase tracking-[0.14em] font-semibold text-(--bg) transition-all duration-150 disabled:opacity-60 cursor-pointer border-none hover:opacity-90 bg-[var(--v3-accent)]"')
content = content.replace('className="w-full h-[52px] rounded-[10px] font-mono text-[11px] uppercase tracking-[0.14em] font-semibold text-(--bg) transition-all duration-150 disabled:opacity-60 cursor-pointer border-none hover:opacity-90"\n            className="w-full h-[52px] rounded-[10px] font-mono text-[12px] uppercase tracking-[0.14em] font-semibold text-(--bg) transition-all duration-150 disabled:opacity-60 cursor-pointer border-none hover:opacity-90 bg-[var(--v3-accent)]"', 'className="w-full h-[52px] rounded-[10px] font-mono text-[12px] uppercase tracking-[0.14em] font-semibold text-(--bg) transition-all duration-150 disabled:opacity-60 cursor-pointer border-none hover:opacity-90 bg-[var(--v3-accent)]"')
content = content.replace('className="w-full h-[52px] rounded-[10px] font-mono text-[11px] uppercase tracking-[0.14em] font-semibold text-(--bg) transition-all duration-150 disabled:opacity-60 cursor-pointer border-none hover:opacity-90"', 'className="w-full h-[52px] rounded-[10px] font-mono text-[12px] uppercase tracking-[0.14em] font-semibold text-(--bg) transition-all duration-150 disabled:opacity-60 cursor-pointer border-none hover:opacity-90 bg-[var(--v3-accent)]"')
